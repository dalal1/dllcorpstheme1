...
get_header(); ?>
	...
	<div id="primary">
      ...
      <?php if ( get_theme_mod( 'dllcorpstheme1_related_posts_activate', 0 ) == 1 )
         get_template_part( 'inc/related-posts' );
      ?>

      <?php
         do_action( 'dllcorpstheme1_before_comments_template' );
         // If comments are open or we have at least one comment, load up the comment template
         if ( comments_open() || '0' != get_comments_number() )
            comments_template();
         do_action ( 'dllcorpstheme1_after_comments_template' );
      ?>
