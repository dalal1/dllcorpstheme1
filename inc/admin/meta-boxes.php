 ...
 */
 ...
 add_action( 'add_meta_boxes', 'dllcorpstheme1_add_custom_box' );
/**
 * Add Meta Boxes.
 */
function dllcorpstheme1_add_custom_box() {
	// Adding layout meta box for page
	add_meta_box( 'page-layout', __( 'Select Layout', 'dllcorpstheme1' ), 'dllcorpstheme1_page_layout', 'page', 'side', 'default' );
	// Adding layout meta box for
	add_meta_box( 'page-layout', __( 'Select Layout', 'dllcorpstheme1' ), 'dllcorpstheme1_page_layout', 'post', 'side', 'default' );
}
...
$page_layout = array(
							'default-layout' 	=> array(
														'id'			=> 'dllcorpstheme1_page_layout',
														'value' 		=> 'default_layout',
														'label' 		=> __( 'Default Layout', 'dllcorpstheme1' )
														),
							'right-sidebar' 	=> array(
														'id'			=> 'dllcorpstheme1_page_layout',
														'value' 		=> 'right_sidebar',
														'label' 		=> __( 'Right Sidebar', 'dllcorpstheme1' )
														),
							'left-sidebar' 	=> array(
														'id'			=> 'dllcorpstheme1_page_layout',
														'value' 		=> 'left_sidebar',
														'label' 		=> __( 'Left Sidebar', 'dllcorpstheme1' )
														),
							'no-sidebar-full-width' => array(
															'id'			=> 'dllcorpstheme1_page_layout',
															'value' 		=> 'no_sidebar_full_width',
															'label' 		=> __( 'No Sidebar Full Width', 'dllcorpstheme1' )
															),
							'no-sidebar-content-centered' => array(
															'id'			=> 'dllcorpstheme1_page_layout',
															'value' 		=> 'no_sidebar_content_centered',
															'label' 		=> __( 'No Sidebar Content Centered', 'dllcorpstheme1' )
															)
						);
 ...
 */
function dllcorpstheme1_page_layout() {
...
add_action('pre_post_update', 'dllcorpstheme1_save_custom_meta');
/**
 * save the custom metabox data
 * @hooked to pre_post_update hook
 */
function dllcorpstheme1_save_custom_meta( $post_id ) {
	global $page_layout, $post;
